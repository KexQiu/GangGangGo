...
--> statement-breakpoint
CREATE TABLE "buddy_nudge_daily_counters" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "buddy_nudge_daily_counter_count_check" CHECK ("buddy_nudge_daily_counters"."count" >= 0)
);
--> statement-breakpoint
...
ALTER TABLE "buddy_nudge_daily_counters" ADD CONSTRAINT "buddy_nudge_daily_counters_from_user_id_users_id_fk" FOREIGN KEY ("from_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "buddy_nudge_daily_counters" ADD CONSTRAINT "buddy_nudge_daily_counters_to_user_id_users_id_fk" FOREIGN KEY ("to_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "buddy_nudge_daily_counter_unique" ON "buddy_nudge_daily_counters" USING btree ("from_user_id","to_user_id","local_date");--> statement-breakpoint
...
CREATE INDEX "buddy_nudges_from_created_idx" ON "buddy_nudges" USING btree ("from_user_id","created_at");--> statement-breakpoint
...
CREATE INDEX "buddy_nudges_team_from_to_created_idx" ON "buddy_nudges" USING btree ("team_id","from_user_id","to_user_id","created_at");--> statement-breakpoint
...
CREATE UNIQUE INDEX "team_members_user_current_unique" ON "team_members" USING btree ("user_id") WHERE "team_members"."removed_at" is null;--> statement-breakpoint
