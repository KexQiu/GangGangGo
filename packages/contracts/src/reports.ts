...
export const dailyReportSnapshotSchema = dailyShareSnapshotSchema.extend({ toiletLongMeeting: z.boolean() });
export type DailyReportSnapshot = z.infer<typeof dailyReportSnapshotSchema>;
export const upsertDailyReportSnapshotRequestSchema = z.object({ snapshot: dailyReportSnapshotSchema });
export type UpsertDailyReportSnapshotRequest = z.infer<typeof upsertDailyReportSnapshotRequestSchema>;
export const upsertDailyReportSnapshotsBulkRequestSchema = z.object({
...
export const dailyReportSnapshotResponseSchema = z.object({ snapshot: dailyReportSnapshotSchema });
export type DailyReportSnapshotResponse = z.infer<typeof dailyReportSnapshotResponseSchema>;
export const dailyReportSnapshotsBulkResponseSchema = z.object({ snapshots: z.array(dailyReportSnapshotSchema) });
...
export const advancedReportResponseSchema = z.object({
...
export const teamWeeklyReportResponseSchema = z.object({
  endedAt: isoDateSchema,
